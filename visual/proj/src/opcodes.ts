enum CONTROL_SIGNALS {
    PC_HIGH_WRITE_DBUS = 1 << 28,
    PC_LOW_WRITE_DBUS = 1 << 27,
    SP_DECREMENT = 1 << 26,
    SP_INCREMENT = 1 << 25,
    SP_READ_DBUS = 1 << 24,
    SP_WRITE_ABUS = 1 << 23,
...
let INC_M_MICROCODE = [
    ...
    CONTROL_SIGNALS.HL_WRITE_ABUS | CONTROL_SIGNALS.MEMORY_READ,
    CONTROL_SIGNALS.A_READ_DBUS ,
    CONTROL_SIGNALS.ALU_BUFFER_READ_DBUS | CONTROL_SIGNALS.ALU_FLAG_SET_ENABLE | CONTROL_SIGNALS.ALU_INCREMENT,
...
let PUSH_MICROCODE = [
    CONTROL_SIGNALS.SP_WRITE_ABUS  | CONTROL_SIGNALS.A_WRITE_DBUS | CONTROL_SIGNALS.MEMORY_WRITE,
    CONTROL_SIGNALS.SP_INCREMENT
]
let POP_MICROCODE = [
    CONTROL_SIGNALS.SP_DECREMENT,
    CONTROL_SIGNALS.SP_WRITE_ABUS  | CONTROL_SIGNALS.MEMORY_READ | CONTROL_SIGNALS.A_READ_DBUS 
]
...
let JSR_MICROCODE = [
    ...
    CONTROL_SIGNALS.PC_WRITE_ABUS| CONTROL_SIGNALS.MEMORY_READ,
    CONTROL_SIGNALS.H_READ_DBUS | CONTROL_SIGNALS.PC_INCREMENT,
    CONTROL_SIGNALS.PC_LOW_WRITE_DBUS | CONTROL_SIGNALS.A_READ_DBUS,
    ...PUSH_MICROCODE,
    CONTROL_SIGNALS.PC_HIGH_WRITE_DBUS | CONTROL_SIGNALS.A_READ_DBUS,
    ...PUSH_MICROCODE,
    CONTROL_SIGNALS.HL_WRITE_ABUS,CONTROL_SIGNALS.PC_READ_ABUS
]
...
let RET_MICROCODE = [
    ...POP_MICROCODE,
    CONTROL_SIGNALS.A_WRITE_DBUS | CONTROL_SIGNALS.H_READ_DBUS,
    ...POP_MICROCODE,
    CONTROL_SIGNALS.A_WRITE_DBUS | CONTROL_SIGNALS.L_READ_DBUS,
    CONTROL_SIGNALS.HL_WRITE_ABUS | CONTROL_SIGNALS.PC_READ_ABUS
]
...
let LDI_MICROCODE=[
    CONTROL_SIGNALS.PC_WRITE_ABUS| CONTROL_SIGNALS.MEMORY_READ,
    CONTROL_SIGNALS.A_READ_DBUS | CONTROL_SIGNALS.PC_INCREMENT,
]
...
export default class OPCODES{
    ...
    constructor(){
        this.opcodes = [
            ...
            {code:0x13,mnemonic:"LDB",microcode:LDB_MICROCODE,operandCount:2} ,
            {code:0x14,mnemonic:"PUSH",microcode:PUSH_MICROCODE,operandCount:0} ,
            {code:0x15,mnemonic:"POP",microcode:POP_MICROCODE,operandCount:0} ,
            {code:0x16,mnemonic:"JSR",microcode:JSR_MICROCODE,operandCount:2} ,
            {code:0x17,mnemonic:"RET",microcode:RET_MICROCODE,operandCount:0} ,
            {code:0x18,mnemonic:"LDI",microcode:LDI_MICROCODE,operandCount:1} ,
